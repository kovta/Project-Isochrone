...
GRANT SELECT, INSERT, UPDATE, DELETE ON 
objectives, projects, submodules, submodule_dependencies, tasks, task_dependencies, task_estimations,
objective_projects, objective_tasks, project_submodules, project_tasks, submodule_tasks TO stratagem_std_user;
GRANT USAGE, SELECT, UPDATE ON 
objectives_objective_id_seq, projects_project_id_seq, submodules_submodule_id_seq, submodule_dependencies_dependency_id_seq, tasks_task_id_seq,
