...
public class SubmoduleDevelopmentProcessorImpl extends AbstractDevelopmentProcessor implements DevelopmentProcessor {
	...
	public void processCreation(String message) throws PersistenceServiceException {
		...
		this.handleCreationProperties(attributes, Constants.SUBMODULE_DATA_NAME, recipients);
	}
	...
	public void processAssignment(String message) throws PersistenceServiceException {
		...
		this.handleAssignmentProperties(attributes, Constants.SUBMODULE_DATA_NAME, attributes.get(Constants.SUBMODULE_NAME_ATTRIBUTE_DATA_NAME));
	}
	...
	public void processDissociation(String message) throws PersistenceServiceException {
		...
		this.handleDissociationProperties(attributes, Constants.SUBMODULE_DATA_NAME, attributes.get(Constants.SUBMODULE_NAME_ATTRIBUTE_DATA_NAME));
	}
	...
	public void processModification(String originMessage, String resultMessage) throws PersistenceServiceException {
		...
		this.handleModificationProperties(origin_attributes, result_attributes, Constants.SUBMODULE_DATA_NAME, recipients);
	}
	...
	public void processDeletion(String message, String operator) throws PersistenceServiceException {
		...
		this.handleDeletionProperties(attributes, Constants.SUBMODULE_DATA_NAME, operator, recipients);
	}
