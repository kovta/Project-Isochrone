...
public class TaskDevelopmentProcessorImpl extends AbstractDevelopmentProcessor implements DependencyExtendedDevelopmentProcessor {
	...
	public void processCreation(String message) throws PersistenceServiceException {
		...
		if (!attributes.get(Constants.OBJECTIVE_ID_ATTRIBUTE_DATA_LABEL).equals(Constants.UNSPECIFIED_ATTRIBUTE)) {
		...
		} else if (!attributes.get(Constants.PROJECT_ID_ATTRIBUTE_DATA_LABEL).equals(Constants.UNSPECIFIED_ATTRIBUTE)) {
			recipients.add(this.appUserService.readElementary(
		...
		} else if (!attributes.get(Constants.SUBMODULE_ID_ATTRIBUTE_DATA_LABEL).equals(Constants.UNSPECIFIED_ATTRIBUTE)) {
			recipients.add(this.appUserService.readElementary(
