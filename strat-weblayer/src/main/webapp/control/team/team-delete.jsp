...
<!--Modal: Team Delete Form-->
<div class="modal fade" id="deleteTeam" tabindex="-1" role="dialog" aria-labelledby="TeamModal" aria-hidden="true">
    <div class="modal-dialog cascading-modal" role="document">
        <!--Content-->
        <div class="modal-content">
            <!--Header-->
            <div class="modal-header danger-color-dark white-text">
                <h4 class="title"><i class="fa fa-trash"></i>Delete Team</h4>
            </div>
            <!--Body-->
